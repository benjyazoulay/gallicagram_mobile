...
shinyUI(fluidPage(
  ...
  mobileDetect('isMobile'),
                      ...
                      fluidPage(
                        column(12,rclipboardSetup(),
                               div(style="display: inline-block;vertical-align:bottom",
                                   dropdownButton(tags$h3("Paramètres de recherche"),
                                                  ...
                                                  icon = icon("bars"), width = "400px",
                                                  tooltip = tooltipOptions(title = "Paramètres de recherche")
                                   )),
                               div(style="display: inline-block;vertical-align:bottom",dropdownButton(tags$h3("Options avancées"),checkboxInput("barplot", "Distribution des documents de la base de données ", value = FALSE),
                                                  div(style = "margin-top: -15px"),

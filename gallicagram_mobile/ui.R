...
#               "),
  ...
  bs4DashPage(fullscreen = T,
                bs4DashNavbar(title=span(img(src = "Logo1.png", height = 35), ""),
                    fixed = T),
    bs4DashSidebar(skin="light",minified = F,
                   menuItem("Graphique", tabName = "graphique", icon = icon("dashboard")),
                   menuItem("Cartographie", tabName = "cartographie", icon = icon("map"))
                   ),
    bs4DashBody(
      bs4TabItem("graphique",
      useShinyjs(),
    ...
    bs4TabItem("cartographie",
               box(textInput("cartoMot","Recherche dans Gallica/presse","Général Boulanger"),
                   div(style = "margin-top: -15px"),
    ...
    bs4DashControlbar(width = 400,skin="light",
